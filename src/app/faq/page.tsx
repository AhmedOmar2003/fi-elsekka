...
const FAQs = [
  ...
  },
  {
    ...
    answer: "عشان نضمن أسرع خدمة وأحسن جودة، التوصيل حالياً متاح في مناطق محددة لتوصيل أسرع وأرخص، وهتلاقي رسوم الشحن بتظهرلك بوضوح قبل ما تأكد الطلب بناءً على عنوانك."
  },
  {
