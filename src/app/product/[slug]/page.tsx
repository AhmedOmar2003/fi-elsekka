...
export default function ProductPage() {
   ...
   React.useEffect(() => {
      // Slight delay so the entry animation plays after paint
   ...
   return (
      <>
         ...
         {/* Slides up with a short entrance animation */}
         <div
            className={`
        ...
        `}
         >
            ...
            <div className="h-6 bg-gradient-to-t from-background to-transparent pointer-events-none"></div>

            <div className="bg-background/97 backdrop-blur-2xl border-t border-surface-hover px-4 pt-3 pb-7 shadow-[0_-12px_40px_rgba(0,0,0,0.5)]">
               {/* Price summary */}
               <div className="flex items-center justify-between mb-3 px-1">
                  <div className="flex flex-col">
                     <span className="text-[11px] font-medium text-gray-500 uppercase tracking-wider">سعر الوحدة</span>
                     <span className="font-heading font-black text-primary text-2xl leading-none">{product.price} <span className="text-sm font-bold">ج.م</span></span>
                  </div>
                  {/* Qty control */}
               ...
               <div className="flex gap-3">
                  ...
                  <button
                     ...
                     className={`
                relative flex-1 h-14 rounded-2xl font-heading font-black text-base overflow-hidden
                transition-all duration-300 active:scale-[0.96]
                ${isAdded
                           ? 'bg-emerald-600 shadow-lg shadow-emerald-600/30'
                           : 'bg-primary shadow-[0_6px_24px_rgba(16,185,129,0.4)] hover:shadow-[0_8px_30px_rgba(16,185,129,0.55)]'
                        }
                text-white
              `}
                  >
                  ...
                  {/* Buy Now - bold secondary */}
                  <button
                     onClick={handleBuyNow}
                     className="h-14 px-5 rounded-2xl font-heading font-black text-base text-white bg-gradient-to-br from-blue-500 to-blue-700 shadow-[0_6px_24px_rgba(59,130,246,0.4)] active:scale-[0.96] transition-all duration-300"
                  >
                     اشتري ⚡
                  </button>
               </div>
