...
function RegisterContent() {
  ...
  return (
    <div className="w-full max-w-md bg-surface-container-low/80 backdrop-blur-xl border border-surface-border/60 rounded-[2rem] p-8 sm:p-12 shadow-premium relative overflow-hidden">
      ...
      {errorMsg && (
        <div className="mb-6 bg-rose-500/10 border border-rose-500/20 text-rose-500 p-4 rounded-xl flex items-start gap-3 text-sm font-medium shadow-sm">
      ...
      {success ? (
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-foreground px-1">الاسم بالكامل</label>
            <Input
              type="text"
              value={fullName}
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-foreground px-1">كلمة المرور</label>
            <PasswordInput
              value={password}
